...
>((props, ref) => {
  ...
  if (numberOfSlides > 1) {
    return (
      <div ref={ref} className={`flex justify-end mt-3 ${props.className}`}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            key={i}
            className={`mx-1 h-3 w-3 rounded-full p-0 border bg-transparent ${
              i === currentSlide
                ? "scale-125 transform bg-primary"
                : "hover:bg-primary"
            }`}
